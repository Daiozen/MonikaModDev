...
label mas_song_shelter:
    ...
    if mas_getEV('mas_song_shelter').shown_count == 0:
        ...
        extend 2duu "but there will always be someone."
        m "I promise."
    ...
    extend 4ekb "And besides, there are tons of people out there would like nothing more than to know we're happy..."
    m 4dku "Even if they don't know our names or faces..."
    m 1huu "We're not alone, [player]. There always will be someone out there rooting for us us!"
    return
